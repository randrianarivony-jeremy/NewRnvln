      ...
      <BrowserRouter>
        <ROUTES>
            ...
            <Route
              ...
              element={
                <Suspense fallback={<Loader />}>
                  {currentUser ? <SubscriptionOnly /> : <Login />}
                </Suspense>
              }
            />
            <Route
          ...
          <Route
            ...
            element={
              <Suspense fallback={<Loader />}>
                {currentUser ? <Notification /> : <Login />}
              </Suspense>
            }
          />
          <Route
          ...
          <Route
            ...
            element={
              <Suspense fallback={<Loader />}>
                {currentUser ? <PublishMedia /> : <Login />}
              </Suspense>
            }
          />
          <Route
          ...
          <Route
            ...
            element={
              <Suspense fallback={<Loader />}>
                {currentUser ? <SearchResult /> : <Login />}
              </Suspense>
            }
          />
        </ROUTES>
