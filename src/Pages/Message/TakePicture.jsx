      ...
      {camera && (
        <>
          <Box position="absolute" zIndex={3} top={0} left={0} height='100%'>
            <WebCam ref={webcamRef} videoConstraints={{facingMode:selfie}} onUserMediaError={()=>setCamera(false)} screenshotFormat="image/jpeg" style={{height:'100%',objectFit:'cover'}} audio={false}/>
          </Box>
